...
A BookStore is a single page application where you add and remove the books.
...
```
git clone your link repo https://github.com/anshuman7negi/book-store.git
cd your folder name
```
### Install
...
You can use this project to add and remove books:
